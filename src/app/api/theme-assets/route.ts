...
const VALID_THEMES = ["luxury","glass","emerald","violet","hotpink","rose","light","blush","azure","goddess","imperial","chrome","walnut","argentum","alchemist","slate","ivory","carbon","alabaster","obsidian","jade","grove","lotus","evolution","abyss","riviera","glacial","peak","tectonic","altitude"];
