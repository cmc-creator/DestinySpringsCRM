...
export async function POST(req: NextRequest) {
  ...
  if (values.length < 2) {
    await logSyncRun(actor, "SUCCESS", "No data rows found", { totalRows: 0, imported: 0, skipped: 0, errors: 0 });
    return NextResponse.json({
  ...
  await logSyncRun(actor, errors > 0 ? "FAILED" : "SUCCESS", "Bedboard sync completed", {
