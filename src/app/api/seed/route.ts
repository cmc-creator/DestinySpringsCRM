...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const opp7 = await prisma.opportunity.create({ data: { title: "Adult Dual Dx Referral - Banner Phoenix Psych", hospitalId: h2.id, assignedRepId: rep1?.id, stage: "INQUIRY", serviceLine: "DUAL_DIAGNOSIS", value: 0, closeDate: new Date("2026-07-01"), priority: "HIGH" } });
