...
const featuredIntegrations = [
  ...
  {
    name: "Microsoft 365 Admissions Referrals Sync",
    badges: [{ label: "SETUP REQUIRED", color: "#f59e0b" }, { label: "REFERRALS", color: "#60a5fa" }],
    desc: "Sync daily bedboard spreadsheet rows from Microsoft 365 into admissions referrals so leadership and BD can track who sent each admission in real time.",
