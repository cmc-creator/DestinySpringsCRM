...
const REPORTS = [
  ...
  {
    id: "discharged",
    title: "Discharged / Closed Won",
    desc: "All discharged patients with value, close date, and winning rep",
    icon: "✅",
    badge: "REVENUE",
    color: "#34d399",
  },
  {
    ...
    desc: "Activity volume, pipeline value, and discharge rate per rep",
    icon: "👥",
    badge: "TEAM",
    color: "#fbbf24",
  },
