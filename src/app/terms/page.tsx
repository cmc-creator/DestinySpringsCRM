      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "60px 2rem 80px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32, lineHeight: 1.8, color: TEXT_MUTED, fontSize: "0.9rem" }}>
          {[
            ...
            { title: "4. Healthcare Data and HIPAA", body: "NyxAegis supports healthcare business workflows and may support approved integrations or document flows that involve Protected Health Information (PHI) for authorized organizations. PHI may be introduced into the Service only when a Business Associate Agreement (BAA) has been fully executed and the applicable integration or workflow has been expressly approved by NyxAegis. Customers remain responsible for ensuring PHI is not uploaded, transmitted, or exposed through non-approved workflows, notes, exports, or integrations." },
            { title: "5. Acceptable Use", body: "You agree not to use the Service for any unlawful purpose, to transmit spam or malware, to attempt to gain unauthorized access to any portion of the Service, to introduce PHI into any workflow or integration that has not been approved under an executed BAA, to reverse engineer or attempt to extract the source code of the Service, or to interfere with or disrupt the integrity or performance of the Service." },
            ...
            { title: "8. Intellectual Property", body: "The Service and its original content, features, and functionality are and will remain the exclusive property of Destiny Springs Healthcare. Our trademarks and trade dress may not be used in connection with any product or service without our prior written consent." },
            { title: "9. Limitation of Liability", body: "Destiny Springs Healthcare shall not be liable for any indirect, incidental, special, consequential or punitive damages resulting from your use of or inability to use the Service. Our total liability shall not exceed the amount you paid for the Service in the 12 months prior to the event giving rise to liability." },
            ...
            { title: "12. Contact", body: "For questions about these Terms, contact us at ops@destinyspringshealthcare.com or Destiny Springs Healthcare, Nashville, TN." },
          ].map((s) => (
            <div key={s.title}>
