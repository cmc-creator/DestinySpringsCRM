      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "60px 2rem 80px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32, lineHeight: 1.8, color: TEXT_MUTED, fontSize: "0.9rem" }}>
          {[
            ...
            { title: "3. HIPAA and Protected Health Information", body: "NyxAegis is a CRM platform for business development activities. It is NOT intended for storing Protected Health Information (PHI) as defined under HIPAA. Our platform manages business relationships, not patient records. If you believe your use case requires PHI storage, please contact us at ops@destinyspringshealthcare.com to discuss a Business Associate Agreement (BAA) and appropriate safeguards." },
            { title: "4. Data Sharing", body: "We share data with: (a) Resend for transactional email delivery; (b) your cloud infrastructure provider (for hosting); (c) legal authorities when required by law. We do not share your hospital relationship data, pipeline data, or business intelligence with any third parties." },
            ...
            { title: "11. Contact Us", body: "For privacy questions, data requests, or to report a privacy concern, contact our team at ops@destinyspringshealthcare.com. For HIPAA-related inquiries, please mark your message with 'HIPAA Inquiry' in the subject line." },
          ].map((s) => (
            <div key={s.title}>
